...
public class Example2 { // 클래스 시작
    ...
    public static void main(String[] args) { // main 시작
        ...
        System.out.println(D.비멤버공유변수); // 가능
        D.비멤버공유변수 = 20;
        ...
        [ static ] * 정적인
            1. 프로그램이 실행될때 메모리가 할당되고 프로그램이 종료될때 메모리가 삭제되는 키워드
            2. 사용법 : static 타입 멤버변수 ------------> static(정적) 변수
            3. 주의할점 : 멤버변수(객체내변수) new 공유x vs static(우선할당) static 공유o
                1) 프로그램내 딱 1개만 존재하는 변수를 선언할때 사용 , 서로다른 객체들이 공유해서 사용한다
        [ 상수 ] : 변하지 않는 변수
            1. 사용법 : static final 타입 상수명;
            2. 주의할점 : 1) 수정불가능 2) 프로그램내 딱 1개 존재 3) 상수명은 대문자 사용
        ...
        [ static 유무 중요한 이유 ]
            ...
            class Test{
                ...
                void main2(){}
                static void main(){
                    main2();            // 불가능 : main 함수는 우선할당이 되면서 main2가 모른다
