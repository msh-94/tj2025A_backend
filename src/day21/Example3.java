...
class Calculator{
    ...
    // synchronized : 두개 이상의 스레드가 해당 메소드 사용시 먼저 요청한 스레드가 점령하고 종료될대까지 다른 스레드는 await(대기) 만든다
        ...
        // 주의할점 : 두개 이상의 스레드가 하나의 메소들 호출 할때 비동기 처리를 한다.
        // 동기화 : 두개 이상의 스레드가 하나의 메소드를 순서대로 호출하고 처리 할대 사용한다
...
public class Example3 { // class start
    public static void main(String[] args) { // main start
        ...
        [ synchronized ] 동기화
            ...
            2. 목적 : 여러 스레드가 동시에 하나의 스레드를 사용하면 멤버변수 충돌 생길 수 있다
            3. 비교
                동기화                             비동기화(기본값)
