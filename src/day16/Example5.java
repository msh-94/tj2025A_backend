...
public class Example5 { // class start
    public static void main(String[] args) { // main start
        ...
        // CSV이란? 데이터들 간의 속성을 ,(쉼표) 구분 하고 행 간의 \n 구분 한다.
        // 1. https://www.data.go.kr/index.do
        // 2. '부평구 맛있는' 검색
        // 3. "인천광역시 부평구_맛있는 집(맛집) 현황" 클릭
        // 4. https://www.data.go.kr/data/15103411/fileData.do --> [다운로드]
        // 5. 현재 패키지에 저장(인천광역시 부평구_맛있는집(맛집).csv)
        ...
        try { // (4) 모든 코드를 감싼 예외 처리
            ...
            if (file.exists()) {
                ...
                System.out.println( str.split("\n")[1].split(",")[1] ); // 두번째 행 두번째 열 : (주)온누리푸드온누리장작구이
                // --------------------------------------------------------------------
