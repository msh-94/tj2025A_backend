    ...
    public static void main(String[] args) { // main start
        /*
           [출력함수] :
               ...
               (3) System.out.printf();        : f(format) 정해진 형식의 출력 함수
                    -- 형식
                       %s : 문자열 위치    %c : 문자 위치
                       %d : 정수 위치      %f : 실수 위치
                   [ 자릿수 맞춤 ]
        ...
        */
        ...
        System.out.print("자바안녕3"); // 자료 출력 . 끝
        System.out.print("자바안녕4");

        System.out.printf( "%s" , "자바안녕5");
        // [2]
        String name = "유재석"; // String(문자열저장) name(변수명) =(대입) "유재석"(자료) ;(마침)
        int age = 40;          // int(정수타입) age(변수명) =(대입) 40(자료) ;(마침)
        System.out.printf(" 저는 %s 이고 나이는 %d 입니다" , name , age );
        // "~~~~~~~~~ 형식자리 ~~~~~~~~~ , 값1  , 값2    ==> %s에는 name값 대입 , %d에는 age값 대입
        // vs
        System.out.printf(" 저는 " + name + " 이고 나이는 " + age + "입니다"); // +연결연산자 사용
        System.out.printf(" 저는 %s 이고 나이는 %6d 입니다. \n" , name , age); // %6d , 6자릿수안에 정수 표현
        System.out.printf(" 저는 %s 이고 나이는 %-6d 입니다. \n" , name , age); // %-6d , 6자릿수 안에 정수 표현, 왼쪽정렬
        System.out.printf(" 저는 %s 이고 나이는 %06d 입니다. \n" , name , age); // %06d , 6자릿수 안에 정수 표현 , 빈칸은 0채용
        ...
        System.out.println("안녕9\\안녕10\\");  // \\ 백슬레시 출력
    } // main end
} // class end
