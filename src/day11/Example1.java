...
public class Example1 { // class start
    public static void main(String[] args) { // main start
            ...
            [ ArrayList ] 가변길이   , 다양한 메소드/기능 제공
                ...
                3. 사용법
                    ...
                    2) 요소 추가
                        ...
                        * 인덱스란? 배열또는리스트 내 저장된 (요소)값들의 저장순서번호 , 0번부터 시작
                    3) 출력/반환
                        (1) 변수명             : 전체 요소값 문자열 반환
                        (2) 변수명.size();     : 리스트내 전체 요소 개수 반환
        ...
        */
        ...
        System.out.println(리스트객체);
        // ! 중간에 요소 추가
        리스트객체.add(1 , "박명수");   // * 1번 인덱스는 두번재 요소 자리 뜻
        System.out.println(리스트객체);
        ...
        ArrayList<Member> memberList = new ArrayList<>();   // < 꺽은괄호에는 리스트/목록 내 저장할 항목의타입 >
            // 3) 리스트에 객체들을 저장하기
        memberList.add(m1);
        memberList.add(m2);
        memberList.add(m3);
