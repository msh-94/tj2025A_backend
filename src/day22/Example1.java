    ...
    public static void main(String[] args) { // main start
        ...
        [ String 클래스 ] : 자바에서 문자열 표현하는 방법
            ...
            3. 주요메소드
                ...
                5) 문자열A.length()                              : 지정한 문자열의 문자개수 반환
                6) 문자열A.replace( 기존문자열 , 새로운문자열 )      : 지정한 문자열내 (하나)기존문자열이 존재하면 새로운문자열로 변경후 반환 메소드
                   문자열A.replaceAll()                          : 지정한 문자열내 (모든)기존문자열이 존재하면 새로운문자열로 변경후 반환 메소드
                7) 문자열A.subString( 시작인덱스 , [끝인덱스])      : 지정한 문자열내 시작인덱스 부터 끝인덱스 전까지 문자열 반환 메소드
                8) 문자열A.split( 구분문자 )                      : 지정한 문자열내 구분문자가 존재하면 구분문자 기준으로 쪼개서 String[]타입으로 반환 메소드
                9) 문자열A.indexOf( "찾을문자열" )                 : 지정한 문자열내 찾을 문자열이 존재하면 찾은 문자열 인덱스 반환 없으면 -1 반환
                10) 문자열A.contains( "찾을문자열" )               : 지정한 문자열내 찾을 문자열이 존재하면 true 없으면 false 반환
        ...
        */
        ...
        // : 지정한 문자열내 기존문자열을 새로운문자열 생성(NEW)후 반환 메소드
        ...
        // 8) .subString( 시작인덱스 , [끝인덱스전] ); : 시작인덱스부터 끝인덱스 전 까지 문자열 추출
        String str13 = "012345-1230123".substring(0,6); // 0번인덱스 부터 6번 인덱스까지
        ...
        // 활용] 문자열을 바이트 변환 , 파일처리 , 네트워크 , 첨푸파일 업로드 등등
