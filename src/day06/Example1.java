...
public class Example1 {// class start
    ...
    public static void main(String[] args) { // main start
        /*
            [ 배열 ]
                ...
                3. 사용법 :
                    ...
                    4) 삭제/추가 * 특정한 요소 삭제/추가 는 존재하지 않는다. 자바 배열은 고정 길이 이므로 중간에 요소 개수 변경할수 없다.
                    5) 배열과 반복문
                        (1) 일반 for문
                            for( int index = 0; index <= 배열변수.lnegth -1 ; index++ ){
                            타입 변수명 = 배열변수명[index];
                            }
                        (2) 향상된 for문 , 인덱스 없이 배열내 요소값 하니씩 변수에 대입 반복
                            for( 타입 변수명 : 배열변수명 ){
        ...
        */
        ...
        // [4] Arrays.toString(변수명) : 배열내 요소들을 문자열로 반환
