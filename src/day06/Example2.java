...
public class Example2 {// class start
    ...
    public static void main(String[] args) { // main start
        /*
            [ 클래스 와 객체 ]
                1) (손님객)객체 : '주체'가 아닌 의사나 행위를 미치는 대상
                ...
                * 자바의 모든 코드의 컴파일은 클래스 단위로 컴파일(번역) 한다 *
                5) 생활속 예시
                    (1) 학생 객체 만들기
                        1. 클래스 정의한다     즉] 속성 과 기능 정의 --> 특징 , 이벤트 만들기
                ...
                6) 사용법
                    ...
                    < 객체 내 멤버변수 값 수정 >
                        변수명.멤버변수 = 새로운값
                    < 객체 내 멤버변수 추가 / 삭제 불가능 >
                        - 실행 도중에 클래스 정보를 수정할 수 없다. 단점] 유연성 떨어짐
        */
        // [1] 학생 클래스 만들기 , 학생 객체를 만들기 위한 속성과 기능을 정의하는곳
        ...
        // [8] 붕어빵 객체 만들기
            ...
            붕어빵틀[] 빵봉지 = {빵1 , 빵2 , 빵3 };
                // * 서로 다른 속성/타입 들의 데이터들은 묶음 --> 객체 , 내용물/가격 --> 객체
                // * 서로 같은 속성/타입 들의 데이터들은 묶음 --> 배열 , 빵1빵2빵3 ---> 배열

    }// main end

}// Example1 class end

class Student{ // 클래스란? 객체를 만드는 코드가 아닌 개체를 만들기 위해 객체내 필요한 속성 과 기능을 설계/정의 하는곳
