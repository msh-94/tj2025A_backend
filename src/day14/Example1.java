...
//
class 하위클래스 extends 상위클래스{ // 클래스명B extends 클래스A{ }
...
public class Example1 { // class start
    public static void main(String[] args) { // main start
        ...
        obj2.showValue();   // 상위타입 접근 가능
        obj2.showValue2();  // 현재타입
        ...
        // 만일 상위타입/하위타입내 동일한 멤버변수명 존재할때 현재타입 우선
        System.out.println( obj2.value2 );  // 40
        // 하위타입에서 상위타입으로 변환후 동일한 멤버변수 호출시 현재타입
        상위클래스 obj3 = obj2;
        ...
        상위클래스 obj4 = obj2;
        obj4.showValue(); // obj3(상위타입) 일때 *태생*타입의 메소드 실행
