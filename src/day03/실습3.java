...
//        System.out.println("원의 넓이 : "+(d1*d1*3.14));
//
...
//        System.out.println("비율 : "+(d2/d3)*100+"%");
//
...
//        System.out.print("정수 : ");
//        int i1 = scan.nextInt();
//        System.out.println(i1%2 == 1 && i1%7 == 0 );
//
...
//        int i2 = scan.nextInt();
//        System.out.println(i1+i2 >= 150 ? "합격" : "불합격");
//
...
//        String s1 = scan.next();
//        System.out.println(s1.equals("유재석") ? s1+"(방장)" : s1);
//
...
//        System.out.print(" 높이 : ");
//        double d2 = scan.nextDouble();
//        System.out.println("삼각형의 넓이 : "+d1*d2/2.0);
//
...
//        int i1 = scan.nextInt();
//        System.out.println("2025년 기준 나이 :"+(2025 - i1));
//
...
//        double d2 = scan.nextDouble();
//        System.out.println("BMI 지수 : "+d2/(d3*d3));
//
...
//        String s2 = scan.next();
//        System.out.println(s1.equals("admin")  || s2.equals("admmin@test.com")  ? "관리자" : "일반 사용자");
//
...
//        System.out.print("점수 : ");
//        int i1 = scan.nextInt();
//        System.out.println(i1 >= 90 ? 'A' : i1 >= 80 && i1 < 90 ? 'B' : i1 < 70 ? 'c' : false);
//
...
//        int i1 = scan.nextInt();
//        System.out.println(i1 >= 20 && i1 <= 29 ? "이벤트 대상입니다." : "이벤트 대상이 아닙니다.");
    }// main end
}// class end
